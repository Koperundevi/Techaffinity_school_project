...
3. from the location /schoosite/schoolsite/ run the below commands to create the required models.

python manage.py makemigrations web
python manage.py migrate

4. Run the application using below command from the location /schoosite/schoolsite/
